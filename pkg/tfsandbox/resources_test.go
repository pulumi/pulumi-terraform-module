...
resource "aws_s3_bucket" "this" {
  ...
  lifecycle_rule { # schema.TypeList (optional, computed)
    enabled = true # required
		...
		rawPlan := runPlan(t, tofu, tfFile)

		assertAttributeValuesForAddress(t, "aws_s3_bucket.this", "lifecycle_rule", *rawPlan, []interface{}{
		...
		assertPlanForAddress(t, "aws_s3_bucket.this", "lifecycle_rule", rawPlan, []resource.PropertyValue{
...
`
		...
		assertAttributeValuesForAddress(t, "aws_s3_bucket.this", "grant", *plan, []interface{}{
			map[string]interface{}{
		...
		assertResourceChangeForAddress(t, "aws_s3_bucket.this", "grant", *plan, []interface{}{
			map[string]interface{}{
				"id": true,
		...
		assertPlanForAddress(t, "aws_s3_bucket.this", "grant", plan, []resource.PropertyValue{
			resource.NewObjectProperty(
				resource.PropertyMap{
					"id":          resource.MakeComputed(resource.NewStringProperty("")),
...
`
		plan := runPlan(t, tofu, tfFile)
		assertAttributeValuesForAddress(t, "aws_instance.this", "ebs_block_device", *plan, []interface{}{
			map[string]interface{}{
		...
		assertResourceChangeForAddress(t, "aws_instance.this", "ebs_block_device", *plan, []interface{}{
			map[string]interface{}{
				"device_name": true,
				"encrypted":   true,
				"iops":        true,
		...
		assertPlanForAddress(t, "aws_instance.this", "ebs_block_device", plan, []resource.PropertyValue{
			resource.NewObjectProperty(
				resource.PropertyMap{
...
`
		plan := runPlan(t, tofu, tfFile)
		assertAttributeValuesForAddress(t, "aws_s3_bucket_metric.this", "filter", *plan, []interface{}{
			map[string]interface{}{
				"access_point": nil,
				"prefix":       nil,
			},
		})
		assertResourceChangeForAddress(t, "aws_s3_bucket_metric.this", "filter", *plan, []interface{}{
			map[string]interface{}{
				"tags": true,
			},
		})

		assertPlanForAddress(t, "aws_s3_bucket_metric.this", "filter", plan, []resource.PropertyValue{
			resource.NewObjectProperty(
				resource.PropertyMap{
...
`
		...
		found := assertAttributeValuesForAddress(t, "aws_s3_object_copy.this", "metadata", *plan, nil)
...
`
		plan := runPlan(t, tofu, tfFile)
		// TypeMap (optional,computed) will show the entire value as computed if one of the values is computed
		assertAttributeValuesForAddress(t, "aws_s3_bucket_lifecycle_configuration.this", "rule", *plan, []interface{}{
			map[string]interface{}{
		...
		assertResourceChangeForAddress(t, "aws_s3_bucket_lifecycle_configuration.this", "rule", *plan, []interface{}{
			map[string]interface{}{
				"abort_incomplete_multipart_upload": []interface{}{},
				"expiration":                        []interface{}{},
				"filter": []interface{}{
		...
		assertPlanForAddress(t, "aws_s3_bucket_lifecycle_configuration.this", "rule", plan, []resource.PropertyValue{
			resource.NewObjectProperty(
				resource.PropertyMap{
					"id":                                resource.NewStringProperty("rule_id"),
...
func assertPlanForAddress(t *testing.T, address string, property string, rawPlan *tfjson.Plan, expected interface{}) {
	t.Helper()
	plan, err := newPlan(rawPlan)
	assert.NoError(t, err)
	resourcePlan, ok := plan.FindResource(ResourceAddress(address))
...
func assertAttributeValuesForAddress(
	...
	assert.Equalf(t, expectedValue, nil, "property %s not found", property)
	return false
}
...
func assertResourceChangeForAddress(
	...
	assert.Equal(t, expectedValue, attributeValues[property])
}
