...
func (t *Tofu) Apply(ctx context.Context, logger Logger, opts RefreshOpts) (*State, error) {
...
// Apply runs the terraform apply command and returns the final state
func (t *Tofu) apply(ctx context.Context, logger Logger, opts RefreshOpts) (*tfjson.State, error) {
