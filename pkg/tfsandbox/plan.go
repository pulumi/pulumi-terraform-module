...
func (t *Tofu) Plan(ctx context.Context, logger Logger, opts RefreshOpts) (*Plan, error) {
...
func (t *Tofu) plan(ctx context.Context, logger Logger, opts RefreshOpts) (*tfjson.Plan, error) {
	return t.planWithOptions(ctx, logger, opts)
}

func (t *Tofu) planWithOptions(ctx context.Context, logger Logger, opts RefreshOpts) (*tfjson.Plan, error) {
