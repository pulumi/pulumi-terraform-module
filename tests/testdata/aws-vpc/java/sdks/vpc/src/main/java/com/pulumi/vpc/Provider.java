...
import com.pulumi.vpc.ProviderArgs;
import com.pulumi.vpc.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:vpc")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vpc", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false, Utilities.getPackageRef());
    }
