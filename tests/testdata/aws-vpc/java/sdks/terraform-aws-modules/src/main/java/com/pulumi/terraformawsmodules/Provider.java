...
package com.pulumi.terraformawsmodules;

import com.pulumi.core.Output;
import com.pulumi.core.annotations.ResourceType;
import com.pulumi.core.internal.Codegen;
import com.pulumi.terraformawsmodules.ProviderArgs;
import com.pulumi.terraformawsmodules.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:terraform-aws-modules")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("terraform-aws-modules", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false, Utilities.getPackageRef());
    }
