...
@ResourceType(type="terraform-aws-modules:index:Vpc")
public class Vpc extends com.pulumi.resources.ComponentResource {
    ...
    public Vpc(java.lang.String name, @Nullable VpcArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        super("terraform-aws-modules:index:Vpc", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), true, Utilities.getPackageRef());
    }
