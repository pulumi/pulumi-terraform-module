...
func NewModule(ctx *pulumi.Context,
	...
	var resource Module
	err = ctx.RegisterPackageResource("vpc:index:Module", name, args, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetModule(ctx *pulumi.Context,
	...
	err = ctx.ReadPackageResource("vpc:index:Module", name, id, state, &resource, ref, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
