...
func PkgVersion() (semver.Version, error) {
	...
	re := regexp.MustCompile("^.*/pulumi-terraform-aws-modules/sdk(/v\\d+)?")
...
func PkgGetPackageRef(ctx *pulumi.Context) (string, error) {
	if packageRef == nil {
		...
		parameter, err := base64.StdEncoding.DecodeString("ewogICJtb2R1bGUiOiAidGVycmFmb3JtLWF3cy1tb2R1bGVzL3ZwYy9hd3MiLAogICJ2ZXJzaW9uIjogIjUuMTguMSIKfQ==")
		if err != nil {
			return "", err
		}

		resp, err := ctx.RegisterPackage(&pulumirpc.RegisterPackageRequest{
			Name:        "terraform-module-provider",
			Version:     "0.0.1",
			DownloadUrl: "",
