...
public class Utilities {
    ...
    static {
        var resourceName = "com/pulumi/vpc/version.txt";
	...
	static {
		packageRef = Deployment.getInstance().registerPackage(
			...
			getVersion(),
			// Parameter
			"ewogICJtb2R1bGUiOiAidGVycmFmb3JtLWF3cy1tb2R1bGVzL3ZwYy9hd3MiLAogICJ2ZXJzaW9uIjogIjUuMTguMSIsCiAgInBhY2thZ2VOYW1lIjogInZwYyIKfQ=="
		);
	}
