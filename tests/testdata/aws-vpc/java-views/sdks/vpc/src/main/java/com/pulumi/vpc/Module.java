...
public class Module extends com.pulumi.resources.CustomResource {
     ...
     */
    public Module(java.lang.String name, @Nullable ModuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vpc:index:Module", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false, Utilities.getPackageRef());
    }

    private Module(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vpc:index:Module", name, null, makeResourceOptions(options, id), false, Utilities.getPackageRef());
    }

    private static ModuleArgs makeArgs(@Nullable ModuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static Module get(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
